...
public class BeverageFragment extends Fragment{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_beverge, container, false);
    }
    ...
    public void spreadMenu() throws JSONException {
        LinearLayout fragment_zone = getView().findViewById(R.id.fragment_beverage_zone);
        fragment_zone.removeAllViews();
        ...
        fragment_zone.addView(scrollMenuLayout);
        ...
        for(int i = 0; i< menuList.size(); i++) {
            ...
            if(menuList.get(i).getString("category1").equals("음료")) {
                // add_menu 레이아웃 인플레이션
